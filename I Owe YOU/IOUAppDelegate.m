...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UINavigationBar appearance] setBarTintColor: [UIColor colorWithRed:0.12 green:0.13 blue:0.16 alpha:1]];
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:0.1 green:0.63 blue:0.75 alpha:1]];
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)notification
{
    if([notification valueForKey:@"entryId"]) {
        ...
        [application setApplicationIconBadgeNumber:[[[notification objectForKey:@"aps"] objectForKey:@"badge"] intValue]];
        
        NSNumberFormatter * f = [[NSNumberFormatter alloc] init];
        [f setNumberStyle:NSNumberFormatterDecimalStyle];
        NSNumber * number = [f numberFromString:[notification valueForKey:@"entryId"]];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ioweyou.sqlite"];
